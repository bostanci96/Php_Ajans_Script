			...
			<div class="navbar-collapse" id="navbar-mobile">
				...
				<ul class="nav navbar-nav float-right">
					<div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
						...
						<div class="mx-50 semi-dark">
							<div class="custom-control custom-switch">
								...
								<label class="custom-control-label layout-name" data-layout="<?php if($ayar["site_tema"]==1){ ?>semi-dark-layout<?php }else{ ?>dark-layout<?php } ?>" for="karanlikmod"></label>
							</div>
						</div>
					...
					<li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="<?php echo ADMIN_URL?>index.php?sayfa=kullanici_duzenle&id=<?php echo $_SESSION["uye_id"];?>"><i class="feather icon-user"></i> Profili Düzenle</a>
							<div class="dropdown-divider"></div><a class="dropdown-item" href="<?php echo ADMIN_URL; ?>ajax.php?p=logout"><i class="feather icon-power"></i> Çıkış Yap</a>
						</div>
					</li>
				</ul>
			</div>

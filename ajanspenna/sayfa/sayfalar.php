				...
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$uyeQuery = $db->query("SELECT * FROM sayfalar WHERE sayfa_id!=2 AND sayfa_id!=3 AND sayfa_id!=4 AND sayfa_id!=6 AND sayfa_id!=7 AND secenekHaber!=1 AND secenekHaber!=2");
							if($uyeQuery->rowCount()){
								foreach($uyeQuery as $uyeRow){
									...
									<tr>
										...
										<td><a target="_blank" href="<?php echo URL. $uyeRow["sayfa_url"];?>">Sayfaya Git </a></td>
										...
										if($uyeRow["sayfa_durum"]==1){ ?>
											...
											<td > <div class="dropdown dropright">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													...
													<a class="dropdown-item"  onclick="TekSil(<?php echo $uyeRow["sayfa_id"];?>);" >Sayfayı Sil</a>
												</div>
											</div>   
